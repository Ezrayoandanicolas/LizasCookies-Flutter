...
final adminCategoriesProvider =
    StateNotifierProvider<AdminCategoriesNotifier, AsyncValue<List<Map>>>(
        (ref) {
...
class AdminCategoriesNotifier extends StateNotifier<AsyncValue<List<Map>>> {
  ...
  AdminCategoriesNotifier(this._dio, this._tenantQp)
  ...
  Future<void> load() async {
    ...
    try {
      final res = await _dio.get('/superadmin/product-categories',
  ...
  Future<bool> add(String name, String? description) async {
    try {
      await _dio.post('/superadmin/product-categories',
          data: {
            'name': name,
  ...
  Future<bool> update(int id, String name, String? description) async {
    try {
      await _dio.put('/superadmin/product-categories/$id',
          data: {
            'name': name,
  ...
  Future<bool> delete(int id) async {
    try {
      await _dio.delete('/superadmin/product-categories/$id',
          queryParameters: _tenantQp);
      await load();
      return true;
    } catch (e) {
      ...
      body: categories.when(
        ...
        error: (e, _) => Center(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            ElevatedButton(
                onPressed: () =>
                    ref.read(adminCategoriesProvider.notifier).load(),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10),
                      borderSide:
                          BorderSide(color: sheetTheme.colorScheme.primary)),
                ),
              ),
